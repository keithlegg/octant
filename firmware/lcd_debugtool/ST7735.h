...
// Outputs: none
void ST7735_PlotPoint(uint8_t y);
...
// Inputs: y is the y coordinate of the point plotted
// Outputs: none
//void ST7735_PlotLine(uint8_t y);
...
// Outputs: none
void ST7735_PlotPoints(uint8_t y1,uint8_t y2);
...
// Outputs: none
void ST7735_PlotdBfs(uint8_t y);
...
// Input:  16-bit packed color
// Output: none
void Output_Color(uint16_t newColor);
